...
Deploying *Project Management App* and trying it out at your own institution is itself a way of contributing to the development process.
...
Once you are using *Project Management App* the creation of new issues through GitHub is a major method of contribution towards *Project Management App* development.
...
Each *PR* will need to be reviewed by a *Project Management App* developer.
...
If you have any additional questions please contact the *Project Management App* developers at helpdesk@library.tamu.edu.
